    ...
    <article class="item-card archive-card${soldClass}">
      ...
      <div class="item-body">
        ...
        <div class="item-card__actions">
          ...
          ${listingUrl ? `<a class="card-link card-link--external" href="${escapeHTML(listingUrl)}" target="_blank" rel="noopener">View listing</a>` : ""}
        </div>
      </div>
    </article>
  `;
  ...
  productPage.innerHTML = `
    <article class="product-layout${soldClass}">
      <div class="product-media">
        ${imageUrl
          ? `<img src="${escapeHTML(imageUrl)}" alt="${escapeHTML(item.brand || "Closet item")} ${escapeHTML(item.name || "")}" />`
          : `<div class="product-media__placeholder">No image</div>`
        }
      </div>
      ...
      <div class="product-info">
        ...
        <dl class="product-details">
          ...
          ${productDetailRow("Price", item.price)}
        ...
        <div class="product-actions">
          ${listingUrl ? `<a class="product-link product-link--external" href="${escapeHTML(listingUrl)}" target="_blank" rel="noopener">View listing</a>` : ""}
          <a class="product-link" href="index.html#closet-capital">← Back to portfolio</a>
        </div>
      </div>
    </article>
